...
$db = 'zaidshah_client_site';     // Name of the database
$port = '3306';                           // Port is usually 3306 in Hostgator
$charset = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = 'zaidshah_client_site_admin';     // Enter YOUR cPanel username and user here
$password = 'ydn9g+]MhcE9';           // Enter YOUR user password here
